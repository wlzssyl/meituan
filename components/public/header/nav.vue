  ...
  <div class="m-nav">
    <ul class="nav">
      <li class="list">
        ...
        <dl>
          <dd>
            <nuxt-link to="/1">我的订单</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/2">我的收藏</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/3">抵用券</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="/4">账户设置</nuxt-link>
          </dd>
        </dl>
      </li>
      <li>
      ...
      <li class="list bd">
        ...
        <dl>
          ...
          <dd><nuxt-link to="/kaipiao">商家申请开发票</nuxt-link></dd>
        </dl>
      </li>
      <li class="list site">
